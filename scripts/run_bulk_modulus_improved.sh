...
# Bulk modulus: best single-model config from report (MAE=14.505715, P95=46.439491)
# Original MAE=13.576680, so we need to beat that
run_small \
    ...
    --prediction-min 0 \
    --run-name bulk_modulus_kv_h128_smoothl1_low08_high2_clamp_e25_seed123
